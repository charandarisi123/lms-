  ...
  return (
    ...
    >
      <div className="w-full min-h-[35vh] dark:bg-slate-500 dark:bg-opacity-20 backdrop-blur border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner">
        ...
        /> */}
        <img
          src="https://coderstrustbd.com/wp-content/uploads/2023/03/Mern-Stack.jpg"
          width={500}
          height={300}
        ...
        />
        <br />
        <h1 className="font-Poppins text-[16px] text-black Idark:text-[#fff]">
          {item.name}
        </h1>
        <div className="w-full flex items-center justify-between pt-2">
          <Ratings rating={item.ratings} />
          <h5
            className={`text-black Idark:text-[#fff] ${
        ...
        <div className="w-full flex items-center justify-between pt-3">
          <div className="flex">
            ...
            <h5 className="pl-3 text-[14px] mt-[-5px] line-through opacity-80 text-black Idark:text-[#fff]">
              {item.estimatedPrice}$
            </h5>
          </div>
