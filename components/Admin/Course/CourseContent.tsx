                        ...
                        className={`text-[20px] ${
                          item.videoSection === "Untitled Section"
                            ...
                            : "w-min"
                                        ...
                                        font-Poppins cursor-pointer dark:text-white text-black bg-transparent outline-non
                                    `}
                ...
                {!isCollapsed[index] && (
                  <>
                    ...
                    <div className="inline-block mb-4">
                      <p
                        className="flex items-center text-[18px] Idark:text-white ☐ text-black cursor-pointer"
